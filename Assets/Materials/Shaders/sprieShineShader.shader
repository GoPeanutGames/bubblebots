...
Shader "Sprites/ShinyDefault"
{
	...
	{
		CGPROGRAM
// Upgrade NOTE: excluded shader from DX11; has structs without semantics (struct appdata_t members _SinTime)
...
#include "UnityCG.cginc"
	...
	fixed4 SampleSpriteTexture(float2 uv)
	{
		...
		//_ShineLocation = location;

		float location = _Time.y - floor(_Time.y);
