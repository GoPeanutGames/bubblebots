...
public class LevelsGameplayManager : MonoBehaviour
{
    private enum LevelsGameplayState
    {
        ShowingLevelText,
        Match3Playing,
        LevelComplete,
    ...
    private LevelsGameplayState gameplayState;
    ...
    public void Start()
    {
        gameplayState = LevelsGameplayState.ShowingLevelText;
    ...
    {
        gameplayState = LevelsGameplayState.LevelComplete;
    }
    ...
    {
        if (gameplayState == LevelsGameplayState.LevelComplete || currentWave.completed)
        {
            return;
        }
    ...
    {
        return gameplayState == LevelsGameplayState.Match3Playing &&
    ...
    private void Update()
    {
        ...
        {
            case LevelsGameplayState.ShowingLevelText:
                StartCoroutine(ShowLevelText(2f, 0.5f));
                break;
            case LevelsGameplayState.Match3Playing:
                match3Manager.UpdateMatch3Logic();
                break;
            case LevelsGameplayState.LevelComplete:
                StartCoroutine(EndLevelSequence());
                match3Manager.UpdateMatch3Logic();
                break;
            case LevelsGameplayState.EndLevelSequence:
                match3Manager.UpdateMatch3Logic();
                break;
        }
    }
